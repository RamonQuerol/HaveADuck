...
import es.upm.etsiinf.haveaduck.otheractivities.phototopato.PhotoToPatoActivity;
import es.upm.etsiinf.haveaduck.otheractivities.showpato.ShowPatoActivity;

public class PhotoQuackAdapter extends BaseAdapter {
    private Fragment ctx;
    private List<PhotoQuack> data;

    public static final String ATTR_ID = "ID";

    public PhotoQuackAdapter(Fragment ctx, List<PhotoQuack> data){
        this.ctx = ctx;
        this.data = data;
    }
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        ((Button)view.findViewById(R.id.pato_item_button_inicio)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(ctx.getContext(), PhotoToPatoActivity.class);
